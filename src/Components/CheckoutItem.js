    ...
    <article className={styles.productItemWrapper}>
      ...
      <div className={styles.infoWrapper}>
        ...
        <div className={styles.editQuantityWrapper}>
          <button onClick={() => decrementAmount(productData)} className={styles.quantityBtn}>-</button>
          <p>{productData.amount}</p>
          <button onClick={() => incrementAmount(productData)} className={styles.quantityBtn}>+</button>
        </div>
      </div>
      <button onClick={() => deleteItem(productData)} className={styles.removeBtn}>Delete</button>
    </article>
  )
}
